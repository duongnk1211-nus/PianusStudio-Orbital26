...
export class Note {
  ...
  attack = (synthRef, barsRef, sideEffect, addOn) => async (time) => {
  ...
  release = (synthRef, barsRef, sideEffect) => async(time) => {
    if (!this.#active) return;
    ...
    if (this.#type == "white") {
      return (
        <div
          ...
          onMouseLeave={() => this.release(synthRef, barsRef, sideEffect)()}
