...
export default function Library() {
  ...
  const goToP1Display = () => { navigate('/library/TwinkleTwinkleLittleStar/display'); }
  const goToP1Learn = () => { navigate('/library/TwinkleTwinkleLittleStar/learn'); }
    ...
    <div className='library-wrapper'>
      ...
      <div className='library-shelf'>
        ...
        <div className='piece-shelf'>
          ...
          <button onClick={goToP1Display}>Listen</button>
